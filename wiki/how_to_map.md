...
The compiler emits runtime notes with `kind`, `time`, `x`, `y`, `direction` in radians, `state: "pending"`, optional `lyricChar`, and optional `includeEndChar`.
