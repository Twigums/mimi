...
|------|-------------|--------|
| **Required (new charts)** | `lyric, 2000, auto, 400, 300, char=輝き` | Displays `輝き`; sources the character at the note time for the funnel |
| Span | `lyric, 2000, auto, 400, 300, char=ねがい, span=3` | Same text; takes the source char plus the next 2 for the funnel |
| Legacy auto (deprecated) | `lyric, 2000, auto, 400, 300` | Auto-fills every char in the hold window — do not author new charts this way |
| Source timestamp (legacy) | `lyric, 2000, auto, 400, 300, src=2350` | Sources the character at **2350 ms** — fragile under retiming; prefer `char=` |
...
```text
lyric, 1000, auto, 360, 300, char=帰
lyric, 1300, auto, 440, 300, char=て
```
...
```text
lyric, 2000, auto, 320, 300, char=お
lyric, 2400, auto, 460, 300, char=ねがい, span=3
```
